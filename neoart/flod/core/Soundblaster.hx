...
@final class Soundblaster 
{
  ...
  @:isVar public var completed (default, set) : Int;
  public var remains     : Int;
  public var samplesLeft : Int;
  public var wave        : ByteArray;

  public var waveform (get, null) : ByteArray;
  ...
  private function set_completed(value : Int) : Int
  {
  ...
  public function get_waveform() : ByteArray 
  {
